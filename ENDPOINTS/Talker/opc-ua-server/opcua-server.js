...
function post_initialize() {
    ...
    function construct_my_address_space(server) {
        ...
        setInterval(function(){
            rawData = new opcua.Variant({dataType: opcua.DataType.String, value:ctr+" AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA" +
