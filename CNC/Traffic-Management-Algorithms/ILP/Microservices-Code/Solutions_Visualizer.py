...
def ILP_results_visualizer(instance):
...
def dataframe_printer(instance, Clean_offsets, Results_latencies):
    Feasibility = False
...
################################################################
Feasibility_indicator, Result_offsets, Clean_offsets_collector, Results_latencies  = ILP_results_visualizer(instance)
...
dataframe_printer(instance, Clean_offsets_collector, Results_latencies)
